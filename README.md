...
ProtectedLabel.Text = " M A R C O  | ID: " .. LocalPlayer.UserId
...
local function UpdateProtectedList()
    ...
    ProtectedLabel.Text = "M A R C O  | Protected: " .. count .. " | ID: " .. LocalPlayer.UserId
end
...
button.Text = "marco glitch"                     -- الاسم الجديد
